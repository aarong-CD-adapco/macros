...
import star.common.PhysicsValueManager;
 ...
 */
public class OpenObjectSelectorForScalarProfilesForCCMP72940Fix extends StarMacro {
    Simulation sim;
    ...
    public void execute() {
        ...
        /**
         * Find active scalar profiles
         */
        ArrayList<QueryPredicate> profilePredicateList = new ArrayList<QueryPredicate>();
        QueryPredicate scalarPros = new TypePredicate(TypeOperator.Is, ScalarProfile.class);
        QueryPredicate physicsVals = new TypePredicate(TypeOperator.Is, PhysicsValueManager.class);
        QueryPredicate relationshipPredicate = new RelationshipPredicate(RelationshipOperator.DescendantOf, physicsVals);
        profilePredicateList.add(scalarPros);
        profilePredicateList.add(relationshipPredicate);
        QueryPredicate activeScalarProfilesPredicate = new CompoundPredicate(CompoundOperator.And, profilePredicateList);
        ...
        queryPredicateList.add(activeScalarProfilesPredicate);
